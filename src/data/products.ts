...
export const newArrivalsData: Product[] = [
  ...
  },
  {
    ...
    category: "Lingerie Sets",
    srcUrl: "/images/moonlite/real-products/blue-lace-bodysuit-01.jpg",
    srcAlt: "Blue Lace Moonlit Set real product image",
    gallery: [
      "/images/moonlite/real-products/blue-lace-bodysuit-01.jpg",
      "/images/moonlite/real-products/blue-lace-bodysuit-detail-01.png",
    ],
    galleryAlts: [
      "Blue Lace Moonlit Set real product image",
      "Blue Lace Moonlit Set real product detail",
    ],
    price: 29.99,
    discount: { amount: 0, percentage: 0 },
    rating: 4.5,
  ...
  },
  {
    ...
    category: "Lingerie Sets",
    srcUrl: "/images/moonlite/real-products/red-lace-dress-01.png",
    srcAlt: "Red Lace Moonlit Set real product image",
    gallery: [
      "/images/moonlite/real-products/red-lace-dress-01.png",
      "/images/moonlite/real-products/red-lace-dress-detail-01.jpg",
      "/images/moonlite/real-products/red-lace-dress-02.jpg",
      "/images/moonlite/real-products/red-lace-dress-03.png",
      "/images/moonlite/real-products/red-lace-dress-04.jpg",
    ],
    galleryAlts: [
      "Red Lace Moonlit Set real product image",
      "Red Lace Moonlit Set real product detail",
      "Red Lace Moonlit Set alternate real product image",
      "Red Lace Moonlit Set real product front view",
      "Red Lace Moonlit Set real product styled view",
    ],
    price: 29.99,
    discount: { amount: 0, percentage: 0 },
    rating: 4.8,
  ...
  },
  {
    ...
    category: "Lingerie Sets",
    srcUrl: "/images/moonlite/real-products/black-lace-dress-01.jpg",
    srcAlt: "Black Lace Nocturne Set real product image",
    gallery: [
      "/images/moonlite/real-products/black-lace-dress-01.jpg",
      "/images/moonlite/real-products/black-lace-dress-02.png",
    ],
    galleryAlts: [
      "Black Lace Nocturne Set real product image",
      "Black Lace Nocturne Set alternate real product image",
    ],
    price: 29.99,
    discount: { amount: 0, percentage: 0 },
    rating: 4.6,
