          ...
          <div className="flex items-center flex-wrap">
            {[
              ...
              <button
                ...
                type="button"
                className={cn([
                  "bg-white/10 text-white/70 m-1 flex items-center justify-center px-5 py-2.5 text-sm rounded-full max-h-[39px]",
                  selected === size && "bg-[#8b7cf6] font-medium text-white",
                ])}
